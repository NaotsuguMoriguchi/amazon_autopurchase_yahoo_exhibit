				...
				<div class="tab-content">
					<div class="tab-pane fade show active" id="navs-pills-justified-amazon" role="tabpanel">
						<div class="form-group row mb-3">
							...
							<div class="col-md-10">
								<input type="text" class="form-control" id="access_key" name="access_key" value="{{ $user->access_key }}" onchange="setColumn(event);" />
							</div>
						</div>
						...
						<div class="form-group row mb-3">
							...
							<div class="col-md-10">
								<input type="text" class="form-control" id="secret_key" name="secret_key" value="{{ $user->secret_key }}" onchange="setColumn(event);" />
							</div>
						</div>
						...
						<div class="form-group row mb-3">
							...
							<div class="col-md-10">
								<input type="text" class="form-control" id="partner_tag" name="partner_tag" value="{{ $user->partner_tag }}" onchange="setColumn(event);" />
							</div>
						</div>
					</div>
					<div class="tab-pane fade" id="navs-pills-justified-yahoo" role="tabpanel">
						...
						<div class="form-group row mb-3">
							<label for="yahoo_id" class="col-md-2 col-form-label">Yahoo Application ID</label>
							<div class="col-md-10">
								<input type="text" class="form-control" id="yahoo_id" name="yahoo_id" value="{{ $user->yahoo_id }}" onchange="setColumn(event);" />
							</div>
						</div>

						<div class="form-group row mb-3">
							<label for="yahoo_secret" class="col-md-2 col-form-label">Yahoo Secret Key</label>
							<div class="col-md-10">
								<input type="text" class="form-control" id="yahoo_secret" name="yahoo_secret" value="{{ $user->yahoo_secret }}" onchange="setColumn(event);" />
							</div>
						</div>
